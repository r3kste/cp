...
fn solve<R: BufRead, W: Write>(mut input: FastInput<R>, mut w: W) {
    ...
    // let t: usize = 1;
    for _ in 0..t {
        let score: u32 = input.next();
        if score > 52 {
            writeln!(w, "{}zz", (char::from_u32(score - 52 + 96)).unwrap());
        } else if score > 27 {
            writeln!(w, "a{}z", (char::from_u32(score - 26 - 1 + 96)).unwrap());
        } else {
            writeln!(w, "aa{}", (char::from_u32(score - 2 + 96)).unwrap());
        }
    }
}
